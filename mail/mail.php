...
$outgoingServerAddress      = 'mail.fatcow.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'hostmaster@driftcreativeagency.com';
$sendingAccountPassword     = 'Iu$3cg3Iu$3cg3';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'hostmaster@driftcreativeagency.com'; // REQUIRED value.
$recipientName              = 'Drift hostmaster';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A booking from Your Website'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Impala Car Hire';                // REQUIRED value. This is used when a name or email is not collected from the website form

$timeZone					= 'Africa/Harare';		         // OPTIONAL, but some servers require this to be set. 
